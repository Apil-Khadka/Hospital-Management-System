...
'debugbar.queries.explain','sanctum.csrf-cookie','patients.index','patients.store','patients.show','patients.update',
'patients.destroy','prescriptions.index','prescriptions.store','prescriptions.show','prescriptions.update',
'prescriptions.destroy','appointments.index','appointments.store','appointments.show','appointments.update',
'appointments.destroy','bills.index','bills.store','bills.show','bills.update',
'bills.destroy','lab-orders.index','lab-orders.store','lab-orders.show','lab-orders.update',
'lab-orders.destroy','lab-tests.index','lab-tests.store','lab-tests.show','lab-tests.update',
'lab-tests.destroy','staff.index','staff.store','staff.show','staff.update',
'staff.destroy','storage.local',);
