...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/silent/Development/Web/Laravel/Hospital-Management-System/public/storage' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/silent/Development/Web/Laravel/Hospital-Management-System/public/storage','logging.default',
...
'debugbar.queries.explain','sanctum.csrf-cookie','user.login','user.show',
'user.store','user.update','user.destroy',
'patients.index','patients.store','patients.show','patients.update','patients.destroy',
'prescriptions.index','prescriptions.store','prescriptions.show','prescriptions.update','prescriptions.destroy',
'appointments.index','appointments.store','appointments.show','appointments.update','appointments.destroy',
'bills.index','bills.store','bills.show','bills.update','bills.destroy',
'departments.index','departments.store','departments.show','departments.update','departments.destroy',
'lab-orders.index','lab-orders.store','lab-orders.show','lab-orders.update','lab-orders.destroy',
'lab-tests.index','lab-tests.store','lab-tests.show','lab-tests.update','lab-tests.destroy',
'staff.index','staff.store','staff.show','staff.update','staff.destroy',
'storage.local',);
